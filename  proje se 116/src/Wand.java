public class Wand extends Weapon implements Heal{
    private double HealPower;

    public Wand(){
    }

    public Wand(int tempPowerValue,double tempWeight, double tempValue, int tempHealPower){
        super(tempPowerValue,tempWeight,tempValue);
        HealPower=tempHealPower;
    }
